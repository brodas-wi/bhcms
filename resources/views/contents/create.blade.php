...
<html lang="en">
    ...
    <body>
        <div class="container-fluid py-4">
            ...
            <form id="contentForm" action="/contents" method="POST">
                @csrf
                <input type="hidden" name="content" id="gjs-content">
                <input type="hidden" id="existing-categories"
                    value="{{ isset($content) ? json_encode($content->categories->pluck('id')) : '[]' }}">
                <input type="hidden" id="existing-tags"
                    value="{{ isset($content) ? json_encode($content->tags->pluck('id')) : '[]' }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                            required placeholder="Ingresa el título del contenido">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="featuredImagePreview"
                                            class="bg-light position-relative rounded p-3 text-center">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="excerpt" name="excerpt" rows="3"
                                        placeholder="Escribe un resumen breve de tu contenido..."></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="meta_title" name="meta_title"
                                        maxlength="60" placeholder="Título para buscadores">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="3" maxlength="160"
                                        placeholder="Descripción para resultados de búsqueda"></textarea>
