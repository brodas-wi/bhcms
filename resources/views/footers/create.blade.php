        ...
        <div class="main-wrapper">
            ...
            <div class="editor-toolbar">
                ...
                <div class="toolbar-right">
                    <input type="text" id="footer-name" class="form-control" placeholder="Nombre del Footer">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <h5>Contacto</h5>
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-envelope me-2"></i>info@ejemplo.com</li>
