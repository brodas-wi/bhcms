...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form id="page-form" method="POST">
            ...
            <input type="hidden" name="selected_version" id="selected-version" value="<?php echo e($page->version); ?>">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="type" name="type">
                                    <option value="landing" <?php echo e($page->type == 'landing' ? 'selected' : ''); ?>>Landing
                                    </option>
                                    <option value="blog" <?php echo e($page->type == 'blog' ? 'selected' : ''); ?>>Blog</option>
                                    <option value="ecommerce" <?php echo e($page->type == 'ecommerce' ? 'selected' : ''); ?>>E-commerce
                                    </option>
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="layout" name="layout">
                                    <option value="one_column" <?php echo e($page->layout == 'one_column' ? 'selected' : ''); ?>>Una
                                        Columna</option>
                                    <option value="two_columns" <?php echo e($page->layout == 'two_columns' ? 'selected' : ''); ?>>Dos
                                        Columnas</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category_id">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>"
                                            <?php echo e($page->category_id == $category->id ? 'selected' : ''); ?>>
                            ...
                            <p><strong>Slug:</strong> <span id="page-slug"><?php echo e($page->slug); ?></span></p>
                            <div class="mb-3">
                                <label for="version-select" class="form-label">Versión:</label>
                                <select class="form-select" id="version-select" name="version">
                                    <option value="<?php echo e($page->version); ?>"><?php echo e($page->version); ?> (Actual)</option>
                                    <?php $__currentLoopData = $page->versions()->where('version', '!=', $page->version)->orderBy('version', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($version->version); ?>"><?php echo e($version->version); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <div class="mt-2">
                            ...
                            <p><strong>Autor:</strong> <span id="author-name"><?php echo e($page->user->name); ?></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 order-lg-1">
                    <div class="card mb-4">
                        <img src="<?php echo e($page->thumbnail); ?>" class="card-img-top" id="thumbnail-preview"
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-none">
                                <input type="text" class="form-control" id="user_id" name="user_id"
                                    value="<?php echo e($page->user->id); ?>" required readonly>
                                <input type="text" class="form-control" id="status" name="status"
                                    value="<?php echo e($page->status); ?>" required readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" required><?php echo e($page->description); ?></textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="navbar_id" name="navbar_id">
                                    ...
                                    <?php $__currentLoopData = $navbars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navbar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($navbar->id); ?>"
                                            <?php echo e($page->navbar_id == $navbar->id ? 'selected' : ''); ?>>
                                            <?php echo e($navbar->name); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="footer_id" name="footer_id">
                                    ...
                                    <?php $__currentLoopData = $footers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($footer->id); ?>"
                                            <?php echo e($page->footer_id == $footer->id ? 'selected' : ''); ?>>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <select class="form-select" id="template_id" name="template_id">
                                    ...
                                    <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($template->id); ?>"
                                            <?php echo e($page->template_id == $template->id ? 'selected' : ''); ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="custom_html" name="custom_html" rows="5"><?php echo e($page->content); ?></textarea>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleFormSubmit(e) {
                ...
                const currentVersion = '<?php echo e($page->version); ?>';
            ...
            function submitForm() {
                ...
                fetch('<?php echo e(route('pages.update', $page->id)); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
            ...
            function handleVersionChange() {
                ...
                fetch(`<?php echo e(route('pages.get-version', $page->id)); ?>?version=${selectedVersion}`)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
            ...
            function deleteVersion(version) {
                fetch('<?php echo e(route('pages.deleteVersion', $page->id)); ?>', {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\brian\Documentos\GitHub\bankhipo\website-institucional\bhcms\resources\views/pages/show.blade.php ENDPATH**/ ?>